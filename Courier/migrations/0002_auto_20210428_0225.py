# Generated by Django 3.1.4 on 2021-04-27 20:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('marchant', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Courier.marchant')),
                ('product_category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Courier.product')),
            ],
        ),
    ]
